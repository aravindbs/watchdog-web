...
from wtforms import StringField, PasswordField, SubmitField, SelectField,  TextField, ValidationError , IntegerField , SelectMultipleField
...
#locationchoices = [('class' , 'class') , ('hall' , 'hall')]
